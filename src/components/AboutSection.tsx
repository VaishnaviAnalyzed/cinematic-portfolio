        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Vaishnavi Chandore</span>, an AI & Data Science professional specializing in Computer Vision, Generative AI, and Intelligent Agentic Workflows. My expertise spans building real-time tracking systems using MediaPipe and YOLOv5, local LLM orchestration with Ollama and DeepSeek models, and crafting multimodal AI applications leveraging the Gemini API. Grounded in a strong background in Reinforcement Learning, and machine learning pipeline design, I focus on bridging complex AI models with production-ready web interfaces to deliver scalable, real-world solutions.
            </motion.p>
