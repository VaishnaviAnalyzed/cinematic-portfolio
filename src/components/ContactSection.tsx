...
export const ContactSection: React.FC = () => {
  ...
  return (
    <footer
      id="contact"
      className="relative w-full bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-16 pb-16 px-6 sm:px-12 lg:px-20 overflow-x-hidden"
    >
      <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >Ready to build intelligent computer vision models, agentic workflows, or end-to-end AI applications? Drop a direct message below.
              </p>
        ...
        <div className="pt-16 mt-16 border-t border-[#8C6D4F]/15 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-4">
          ...
          <span className="text-[10px] font-mono text-[#8C6D4F]">
            © {new Date().getFullYear()} • TRAINED WITH PRECISION
          </span>
        </div>
