...
const journey: RouteStop[] = [
  {
    ...
    organization: '1STOP PRIVATE LTD',
    description: 'Performed Exploratory Data Analysis (EDA) on large datasets to identify patterns, trends, and useful business insights.',
  },
  {
    id: '02',
    year: 'JAN - MAR 2026',
    ...
    description: 'Completed hands-on Python development tasks and training modules focused on real-world applications.',
  },
  {
    id: '03',
    year: 'JAN - AUG 2025',
    ...
    description: 'Completed hands-on training in Full Stack Web Development, covering HTML, CSS, JavaScript, React (frontend), and Node.js with Express & MongoDB (backend).',
  },
  {
    id: '04',
    year: '2022 - 2026',
    title: 'B.TECH IN COMPUTER SCIENCE',
    organization: 'BAPURAO DESHMUKH COLLEGE OF ENGINEERING',
  ...
  },
  {
    ...
    organization: 'GANDHI CITY JUNIOR COLLEGE',
    description: 'Completed specialized coursework in Mathematics, Physics, and Chemistry with 63.67% aggregate excellence.',
  },
];
...
export const ExperienceSection: React.FC = () => {
  ...
  return (
    <section
      id="experience"
      ref={containerRef}
      className="relative w-full bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-4 pb-24 px-6 sm:px-12 lg:px-20 overflow-x-hidden"
    >
