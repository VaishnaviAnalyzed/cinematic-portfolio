...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['Gemini API', 'Ollama', 'LangChain', 'Agentic AI', 'Prompt Eng', 'DeepSeek R1'],
    description: 'Specialized in building LLM applications, local inference pipelines with Ollama, structured JSON outputs, and agentic workflows.',
    stat: 'LLM & AGENTIC',
  ...
  },
  {
    ...
    badge: 'HIGH ACCURACY',
    items: ['MediaPipe', 'YOLOv5', 'OpenCV', 'PyTorch', 'Streamlit'],
    description: 'Engineered real-time 33-landmark body pose estimation, object tracking, and manuscript region segmentation pipelines.',
    stat: 'REAL-TIME POSE',
  ...
  },
  {
    ...
    items: ['React.js', 'Node.js', 'Express.js', 'MongoDB Atlas', 'Tailwind CSS', 'REST APIs'],
    description: 'Developed scalable end-to-end applications, responsive dashboards, RESTful services, and secure backend integration.',
    stat: 'MERN STACK',
    colSpan: 'lg:col-span-5',
  },
  {
...
export const SkillsSection: React.FC = () => {
  ...
  return (
    <section
      id="skills"
      className="relative w-screen bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-8 pb-24 px-6 sm:px-12 lg:px-20 overflow-x-hidden flex flex-col justify-center"
    >
      {/* Ambient Glows */}
