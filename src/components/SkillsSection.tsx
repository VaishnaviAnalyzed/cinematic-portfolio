...
export const SkillsSection: React.FC = () => {
  ...
  return (
    <section
      id="skills"
      className="relative w-full bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-8 pb-24 px-6 sm:px-12 lg:px-20 overflow-x-hidden flex flex-col justify-center"
    >
      {/* Ambient Glows */}
